...
const functions = {
    ...
    addTask() {
        let inputTask = document.querySelector('input#input-task').value,
            divMessageTaskAdded = document.querySelector(
                'div.message-task-added'
            ),
            code = this.createID();
    ...
    closeModal() {
        document
            .querySelector('div#bg-modal')
            .classList.remove('modal-actived');
    },
    ...
    addDate: window.addEventListener('load', () => {
        ...
        document.querySelector('header').innerHTML = `
            <div id="date-container">
                ...
                <div>
                    <div id="div-month"> ${
                        dateStrings.month[date.getMonth()]
                    } </div>
